...
import 'package:azkari_app/services/hamd_service.dart';
...
class _HamdScreenState extends State<HamdScreen> {
  ...
  Future<void> _loadDuas() async {
    try {
      final duas = await _service.loadHamdDuas();
      if (mounted) {
        setState(() {
          _duas = duas;
          _isLoading = false;
  ...
  void _showDuaMenu(HamdModel dua) {
  ...
  Widget _buildDuaCard(HamdModel dua) {
